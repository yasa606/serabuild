...
const services = [
  {
    ...
    description:
      "Complete residential building solutions from structural foundation through finishing, guided by a clear and practical process.",
    href: "/services/house-construction",
    icon: Building2,
    image: "/images/house_construction.png", // Place descriptive image assets in your public folder
  },
  {
    number: "02",
    ...
    description:
      "Practical renovation solutions for improving existing spaces, from architectural changes to modern finishing and interior upgrades.",
  ...
  },
  {
    ...
    description:
      "Protection solutions designed to reduce moisture infiltration and help preserve residential structures through demanding conditions.",
          ...
          {services.map((service) => {
            ...
            return (
              ...
              >
                ...
                {/* VISUAL IMAGE LAYER - Boosts informational context without sacrificing structural copy */}
                <div className="relative w-full h-48 bg-[#1E293B] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} services provided by local engineering contractor in Addis Ababa`}
                    fill
                    sizes="(max-w-768px) 100vw, 33vw"
                    className="object-cover transition-transform duration-500 group-hover:scale-105"
                  />
                  {/* Subtle mask to maintain architectural aesthetic */}
                  <div className="absolute inset-0 bg-[#0F172A]/5 group-hover:bg-transparent transition-all duration-300" />
                </div>

                {/* Card content */}
                <div className="flex flex-1 flex-col px-7 py-8 relative">
                  {/* Floating Icon overlapping image border line */}
                  ...
                  {/* Title - Pushed margin slightly to prevent icon conflict */}
                  ...
                  <div className="mt-auto pt-8">
                    <Link
                      href={service.href}
                      className="inline-flex items-center gap-3 border-t border-[#E2E8F0] pt-5 w-full text-[10px] font-black uppercase tracking-[0.16em] text-[#0F172A] transition-colors duration-300 hover:text-[#D4A72C]"
                    >
                      Explore Service
                      <ArrowRight
        ...
        <div className="mt-12 flex flex-col items-start justify-between gap-5 border-t border-[#E2E8F0] pt-6 sm:flex-row sm:items-center">
          <div>
            ...
            <p className="mt-1 text-xs text-[#64748B]">
              Every project begins with understanding the scope and site.
            </p>
          </div>
